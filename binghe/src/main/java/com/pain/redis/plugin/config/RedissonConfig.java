package com.pain.redis.plugin.config;
...
public class RedissonConfig {
    ...
    @ConditionalOnProperty(name = "spring.arrange.type",havingValue = "single")
    ...
    @Bean(name = "redissonClient")
    @ConditionalOnProperty(name = "spring.arrange.type",havingValue = "cluster")
